...
test_cases = {
    0: [([], "靜卦，卦辭")],
    1: [([0], "初"), ([2], "三"), ([5], "上")],
    2: [([0,1], "上二"), ([3,5], "上上"), ([1,2], "上三")],
    3: [([0,1,2], "三爻變"), ([3,4,5], "三爻變"), ([0,2,4], "三爻變")],
    4: [([0,1,2,3], "四爻變"), ([2,3,4,5], "四爻變"), ([0,1,4,5], "四爻變")],
...
print()
for count, desc_list in [(0, "0變爻→本卦卦辭"), (1, "1變爻→該爻爻辭"), (2, "2變爻→上爻"),
                          (3, "3變爻→變卦卦辭"), (4, "4變爻→變卦下卦"), (5, "5變爻→不變爻"), (6, "6變爻→變卦卦辭")]:
    print(f"  ✅ {desc_list}")
